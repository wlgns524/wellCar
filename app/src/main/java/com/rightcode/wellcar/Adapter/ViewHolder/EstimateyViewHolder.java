...
public class EstimateyViewHolder extends CommonRecyclerViewHolder {
    ...
    public EstimateyViewHolder(View viewHolder, Context context) {
    ...
    public void onBind(Store data, Integer position, Boolean isSelect) {
        this.data = data;
